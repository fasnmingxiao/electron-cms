<template>
  <div class="header" v-bind:class="{ wide: isInputFocused }">
    <div class="menu-circle"></div>
    <div class="header-menu">
      <a class="menu-link is-active" href="#">Users</a>
